namespace PP
{
    ...
    public class Document
    {
        ...
        public string SealLabel()
        {
            switch (seal)
            {
                case SealType.Valid:        return "Kingdom of Emmeloord ";
                case SealType.WrongKingdom: return "Princedom of Vorn ";
                case SealType.Expired:      return "Kingdom of Emmeloord ";
                case SealType.Forged:       return "Kingdom of Emmeloord ";
